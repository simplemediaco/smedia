...
<?php require_once('banner-brennan-cosmetic.php'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-sm-offset-1">
					<div class="heading font-f-simplifica margin-b-30">Dr. Brennan Cosmetic Center</div>
	...
	<div class="background-c-grey4 padding-t-100 padding-b-100">
		<div class="container">
			<div class="aspect-ratio-2-1" style="background: url(dist/img/dr_brennan_02.jpg) no-repeat center / cover"></div>
		</div>
	</div>
	<!-- image -->
	...
	<div class="project-nav">
		<div class="project-nav__label">
			<div class="font-s-xxxl font-f-simplifica font-c-white">Email Experience</div>
		</div>
		<div class="project-nav__link">
			<a href="http://smstaging.net/simplemedia-new/works-email-experience.php" class="button-icon">
				<div class="button-icon__wrap">
					<svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
