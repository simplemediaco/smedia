...
<?php require_once('banner-cibo-divino.php'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-sm-offset-1">
					<div class="heading font-f-simplifica margin-b-30">Cibo Divino Marketplace</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-3 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cibo_divino_02.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cibo_divino_03.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cibo_divino_01.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cibo_divino_05.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 margin-b-40">
					<div class="aspect-ratio-2-1" style="background: url(dist/img/cibo_divino_06.jpg) no-repeat center / cover"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="project-nav">
		<div class="project-nav__label">
			<div class="font-s-xxxl font-f-simplifica font-c-white">Dr. Brennan Cosmetic Center</div>
		</div>
		<div class="project-nav__link">
			<a href="http://smstaging.net/simplemedia-new/works-brennan-cosmetic.php" class="button-icon">
				<div class="button-icon__wrap">
					<svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
