	...
	<div class="banner__wrap container">
		<div class="banner__wrap-nav">
			<div class="banner__item">
				<div class="banner__label font-f-sansation font-c-white">Blog</div>
				<div class="banner__title font-f-simplifica font-c-white">What we're up to</div>
			</div>
		</div>
	</div>
	<!-- banner__wrap -->
	<img class="banner__img" src="dist/img/banner-blog.svg">
	<!-- banner__scroll -->
