	...
	<div class="banner__wrap container">
		<div class="banner__wrap-nav works">
			<div class="banner__item">
				<div class="banner__title font-f-simplifica font-c-white">Azzimato</div>
			</div>
		</div>
	</div>
	<!-- banner__wrap -->
	<div class="banner__bg" style="background: url(dist/img/azzimato_03.jpg) no-repeat center / cover"></div>
	<!-- banner__scroll -->
