...
<?php require_once('banner-overly.php'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-sm-offset-1">
					<div class="heading font-f-simplifica margin-b-30">Overly</div>
	...
	<!-- image -->
	<div class="background-c-grey4 padding-t-100 padding-b-30">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/overly_04.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/overly_05.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/overly_02.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 margin-b-40">
					<div class="aspect-ratio-2-1" style="background: url(dist/img/overly_03.jpg) no-repeat center / cover"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="project-nav">
		<div class="project-nav__label">
			<div class="font-s-xxxl font-f-simplifica font-c-white">Sally Evans</div>
		</div>
		<div class="project-nav__link">
			<a href="http://smstaging.net/simplemedia-new/works-sally-evans.php" class="button-icon">
				<div class="button-icon__wrap">
					<svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
