			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0 service margin-t-50">
					...
					<div class="margin-b-20">
						<div class="font-c-teal1 font-f-sansation"><?php echo $service->title; ?></div>
		<div class="margin-b-10 font-f-sansation"><span class="font-c-grey2">Starting at</span> <?php echo $price; ?></div>
                      
                                      <div class="font-s-l"><?php echo  $ser_array; ?></div>
