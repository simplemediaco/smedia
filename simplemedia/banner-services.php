	...
	<div class="banner__wrap container">
		<div class="banner__wrap-nav">
			<div class="banner__item">
				<div class="banner__label font-f-sansation font-c-white">Services</div>
				<div class="banner__title font-f-simplifica font-c-white">What we do</div>
			</div>
		</div>
	</div>
	<!-- banner__wrap -->
	<img class="banner__img" src="dist/img/banner-services.svg">
	<!-- banner__scroll -->
