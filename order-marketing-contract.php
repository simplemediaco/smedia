		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-8 col-md-offset-2">
					<div class="heading font-f-simplifica margin-b-20">Contract Online Marketing Summary Details</div>
					...
					<div class="order-contract"></div>
					<div class="margin-t-50 order-next">
						<a href="http://smstaging.net/simplemedia-new/order-brand-starter-checkout.php" class="button button--b-teal1 font-f-sansation font-c-teal1">Submit</a>
					</div>
				</div>
			</div>
		</div>
