	...
	<div class="banner__wrap container">
		<div class="banner__wrap-nav">
			<div class="banner__item">
				<div class="banner__label font-f-sansation font-c-white">FAQ</div>
				<div class="banner__title font-f-simplifica font-c-white">We're here to help</div>
			</div>
		</div>
	</div>
	<!-- banner__wrap -->
	<img class="banner__img" src="dist/img/banner-faq.svg">
	<!-- banner__scroll -->
