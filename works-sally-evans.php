...
<?php require_once('banner-sally-evans.php'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-sm-offset-1">
					<div class="heading font-f-simplifica margin-b-30">Sally Evans</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/sally_evans_01.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/sally_evans_04.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-4 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/sally_evans_03.jpg) no-repeat center / cover"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="project-nav">
		<div class="project-nav__label">
			<div class="font-s-xxxl font-f-simplifica font-c-white">My Directives</div>
		</div>
		<div class="project-nav__link">
			<a href="http://smstaging.net/simplemedia-new/works-my-directives.php" class="button-icon">
				<div class="button-icon__wrap">
					<svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
