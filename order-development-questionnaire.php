			...
			<div class="row">
				<div class="col-xs-12 col-md-8 col-md-offset-2">
					...
					<div class="margin-b-20">
						<div class="font-s-xs margin-b-10">Is new project or redesign</div>
						<div class="select">
							<select>
					...
					<div class="margin-b-20">
						<div class="font-s-xs margin-b-10">What type of website</div>
						<div class="select">
							<select>
					...
					<div class="margin-b-20">
						<div class="font-s-xs margin-b-10">Site some web references or upload design samples </div>
						<div class="textfield-icon">
							...
							<input class="textfield padding-r-50 font-s-s" type="text" placeholder="http://">
						</div>
					</div>
					<div class="margin-b-20">
					...
					<div class="margin-b-20">
						<div class="font-s-xs margin-b-10">How would you describe your brand’s personality?</div>
						<div class="select">
							<select>
					...
					<div class="margin-b-50">
						<div class="font-s-xs margin-b-10">Do you have existing brand identity (logo)?</div>
						<div class="select">
							<select>
