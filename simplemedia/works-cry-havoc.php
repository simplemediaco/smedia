...
<?php require_once('banner-cry-havoc.php'); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-sm-offset-1">
					<div class="heading font-f-simplifica margin-b-30">Cry Havoc</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cry_havoc_02.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 col-sm-6 margin-b-40">
					<div class="aspect-ratio-1-1" style="background: url(dist/img/cry_havoc_04.jpg) no-repeat center / cover"></div>
				</div>
				<div class="col-xs-12 margin-b-40">
					<div class="aspect-ratio-2-1" style="background: url(dist/img/cry_havoc_03.jpg) no-repeat center / cover"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="project-nav">
		<div class="project-nav__label">
			<div class="font-s-xxxl font-f-simplifica font-c-white">Parking Day</div>
		</div>
		<div class="project-nav__link">
			<a href="http://smstaging.net/simplemedia-new/works-parking-day.php" class="button-icon">
				<div class="button-icon__wrap">
					<svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
